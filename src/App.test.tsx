...
describe('Rainbow Colour Lab site', () => {
  ...
  it('searches services by keyword', async () => {
    ...
    await user.type(screen.getByPlaceholderText(/search printing, gifting/i), 'restoration')

    expect(screen.getByText('Black & White to Color Restoration')).toBeInTheDocument()
    expect(screen.queryByText('Mug Printing')).not.toBeInTheDocument()
  })
